            ...
            children: <Widget>[
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    Icon(Icons.access_time_outlined, size: 32.0),
                    Text('07:15 - 08:00', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
                    Text('Presensi Pagi', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                  ],
                ),
              ),
              Expanded(
